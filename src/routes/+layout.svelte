<script lang="ts">
    ...
    import Container from "@lucide/svelte/icons/tool-case";
    import Message from "@lucide/svelte/icons/message-circle-warning";
...
<nav class="sticky top-0 w-full h-15 bg-accent z-50">
    <div class="h-full md:max-w-332 md:mx-auto flex justify-between">
                ...
                {#snippet child({ props }: any)}
                    <div class="">
                        <Button
                            ...
                            variant="ghost"
                            class="h-full m-0 p-6 underline-offset-5 cursor-pointer text-md text-foreground font-normal hover:bg-white/10!"
                        >
